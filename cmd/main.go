...
func main() {
	...
	flag.StringVar(
		&configFile,
		"config-file",
		"/etc/external-dns-watcher/config.yaml",
		"Path to the config file providing the watches.",
	)
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4c8aa987.external-dns.webhippie.de",
	...
	if err := reconciler.SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create EndpointReconciler")
		os.Exit(1)
	}
